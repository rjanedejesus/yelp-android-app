package com.yep.android.data.local;
...
public class PreferencesHelper {
    ...
    public static final String CURRENT_LOCATION_LONGITUDE = "longitude";
    public static final String CURRENT_LOCATION_LATITUDE = "latitude";
